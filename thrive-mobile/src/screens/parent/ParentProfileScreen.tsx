...
export const ParentProfileScreen: React.FC = () => {
  ...
  const fullName = `${profile?.first_name || 'Valideyn'} ${profile?.last_name || ''}`.trim();
  ...
  return (
    <View style={styles.container}>
      <HeaderBar title="Mənim Profilim" subtitle="Valideyn Hesabı və Tənzimləmələr" />
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <ThriveCard style={styles.userCard}>
          ...
          <View style={{ marginTop: Spacing.sm }}>
            <ThriveBadge label="Valideyn Portalı" variant="primary" />
          </View>
        </ThriveCard>
