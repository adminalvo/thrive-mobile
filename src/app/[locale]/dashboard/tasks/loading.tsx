            ...
            <div className={styles.columnBody}>
              {[1, 2, 3].map((card) => (
                <div key={card} className={styles.card}>
                  <div style={{ width: 50, height: 16, background: "rgba(var(--glass-color), 0.05)", borderRadius: 4, marginBottom: 8 }} />
                  <div style={{ width: "90%", height: 16, background: "rgba(var(--glass-color), 0.05)", borderRadius: 4, marginBottom: 6 }} />
                  <div style={{ width: "65%", height: 12, background: "rgba(var(--glass-color), 0.03)", borderRadius: 4, marginBottom: 12 }} />
                  <div style={{ display: "flex", justifyContent: "space-between", paddingTop: 8, borderTop: "1px solid rgba(var(--glass-color), 0.05)" }}>
                    <div style={{ width: 60, height: 12, background: "rgba(var(--glass-color), 0.04)", borderRadius: 4 }} />
                    <div style={{ width: 60, height: 12, background: "rgba(var(--glass-color), 0.04)", borderRadius: 4 }} />
                  </div>
                </div>
              ))}
