...
export const StudentProfileScreen: React.FC = () => {
  ...
  const fullName = `${profile?.first_name || t('common.student')} ${profile?.last_name || ''}`.trim();
  ...
  return (
    <View style={styles.container}>
      <HeaderBar title={t('student.profileTitle')} subtitle={t('student.profileSubtitle')} />
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <ThriveCard style={styles.userCard}>
          ...
          <View style={{ marginTop: Spacing.sm }}>
            <ThriveRoleBadge role="student" variant="pill" />
          </View>
        </ThriveCard>
        ...
        <ThriveCard style={styles.infoCard}>
          <View style={styles.infoRow}>
            ...
            <View style={styles.infoTextCol}>
              <Text style={styles.infoLabel}>{t('common.student')} {t('auth.emailDetected')}</Text>
          ...
          <View style={styles.infoRow}>
            ...
            <View style={styles.infoTextCol}>
              <Text style={styles.infoLabel}>{t('common.student')} {t('auth.phoneDetected')}</Text>
          ...
          >
            <View style={styles.settingLeft}>
              ...
              <View>
                ...
                <Text style={styles.settingSubtitle}>{t('common.faqStudentDesc')}</Text>
              </View>
            </View>
            <ChevronRight size={18} color={Colors.textMuted} />
          </TouchableOpacity>
