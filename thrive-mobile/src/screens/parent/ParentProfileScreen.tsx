...
export const ParentProfileScreen: React.FC = () => {
  ...
  const fullName = `${profile?.first_name || t('common.parent')} ${profile?.last_name || ''}`.trim();
  ...
  const loadSettings = async () => {
    ...
    try {
      ...
      console.error('Error loading parent settings:', e);
    }
  };
  ...
  return (
    <View style={styles.container}>
      <HeaderBar title={t('parent.profileTitle')} subtitle={t('parent.profileSubtitle')} />
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <ThriveCard style={styles.userCard}>
          ...
          <View style={{ marginTop: Spacing.sm }}>
            <ThriveRoleBadge role="parent" variant="pill" />
          </View>
        </ThriveCard>
        ...
        <ThriveCard style={styles.infoCard}>
          <View style={styles.infoRow}>
            ...
            <View style={styles.infoTextCol}>
              <Text style={styles.infoLabel}>{t('common.parent')} {t('auth.emailDetected')}</Text>
          ...
          <View style={styles.infoRow}>
            ...
            <View style={styles.infoTextCol}>
              <Text style={styles.infoLabel}>{t('common.parent')} {t('auth.phoneDetected')}</Text>
          ...
          >
            <View style={styles.settingLeft}>
              ...
              <View>
                ...
                <Text style={styles.settingSubtitle}>{t('common.faqParentDesc')}</Text>
              </View>
            </View>
            <ChevronRight size={18} color={Colors.textMuted} />
          </TouchableOpacity>
