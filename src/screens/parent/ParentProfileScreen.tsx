      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <ThriveCard style={styles.userCard}>
          ...
          <View style={{ marginTop: Spacing.sm }}>
            <ThriveBadge label={`${t('common.parent')} Portal`} variant="primary" />
          </View>
        </ThriveCard>
        ...
        <ThriveCard style={styles.infoCard}>
          <View style={styles.infoRow}>
            ...
            <View style={styles.infoTextCol}>
              <Text style={styles.infoLabel}>{t('common.parent')} E-poçt</Text>
          ...
          <View style={styles.infoRow}>
            ...
            <View style={styles.infoTextCol}>
              <Text style={styles.infoLabel}>{t('common.parent')} Telefon</Text>
