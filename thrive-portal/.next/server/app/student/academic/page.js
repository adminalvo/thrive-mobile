(()=>{var e={};e.id=752,e.ids=[752],e.modules={846:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},9121:e=>{"use strict";e.exports=require("next/dist/server/app-render/action-async-storage.external.js")},3295:e=>{"use strict";e.exports=require("next/dist/server/app-render/after-task-async-storage.external.js")},9294:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-async-storage.external.js")},3033:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},3873:e=>{"use strict";e.exports=require("path")},1030:(e,t,r)=>{"use strict";r.r(t),r.d(t,{GlobalError:()=>i.a,__next_app__:()=>u,pages:()=>c,routeModule:()=>m,tree:()=>l});var s=r(260),a=r(8203),n=r(5155),i=r.n(n),o=r(7292),d={};for(let e in o)0>["default","tree","pages","GlobalError","__next_app__","routeModule"].indexOf(e)&&(d[e]=()=>o[e]);r.d(t,d);let l=["",{children:["student",{children:["academic",{children:["__PAGE__",{},{page:[()=>Promise.resolve().then(r.bind(r,943)),"C:\\Users\\mexty\\OneDrive\\Desktop\\thrive-crm\\thrive-portal\\src\\app\\student\\academic\\page.tsx"]}]},{}]},{}]},{layout:[()=>Promise.resolve().then(r.bind(r,1354)),"C:\\Users\\mexty\\OneDrive\\Desktop\\thrive-crm\\thrive-portal\\src\\app\\layout.tsx"],"not-found":[()=>Promise.resolve().then(r.t.bind(r,9937,23)),"next/dist/client/components/not-found-error"],forbidden:[()=>Promise.resolve().then(r.t.bind(r,9116,23)),"next/dist/client/components/forbidden-error"],unauthorized:[()=>Promise.resolve().then(r.t.bind(r,1485,23)),"next/dist/client/components/unauthorized-error"]}],c=["C:\\Users\\mexty\\OneDrive\\Desktop\\thrive-crm\\thrive-portal\\src\\app\\student\\academic\\page.tsx"],u={require:r,loadChunk:()=>Promise.resolve()},m=new s.AppPageRouteModule({definition:{kind:a.RouteKind.APP_PAGE,page:"/student/academic/page",pathname:"/student/academic",bundlePath:"",filename:"",appPaths:[]},userland:{loaderTree:l}})},3002:(e,t,r)=>{Promise.resolve().then(r.bind(r,943))},3170:(e,t,r)=>{Promise.resolve().then(r.bind(r,7603))},7603:(e,t,r)=>{"use strict";r.r(t),r.d(t,{default:()=>c});var s=r(5512),a=r(8009),n=r(3093),i=r(8542),o=r(6719),d=r(9333),l=r(4302);function c(){let{profile:e}=(0,d.A)(),{t,locale:r}=(0,l.o)(),[c,u]=(0,a.useState)(null),[m,p]=(0,a.useState)([]),[g,h]=(0,a.useState)([]),[_,f]=(0,a.useState)(!0),x=m.filter(e=>"PRESENT"===e.status||"present"===e.status).length,y=m.length>0?Math.round(x/m.length*100):98;return(0,s.jsx)(n.t,{title:t("nav.academic"),children:(0,s.jsx)("div",{className:"space-y-6",children:(0,s.jsxs)(i.Z,{children:[(0,s.jsxs)("div",{className:"flex items-center justify-between pb-4 border-b border-slate-800/80 mb-6",children:[(0,s.jsxs)("div",{children:[(0,s.jsx)("h3",{className:"text-lg font-bold text-white tracking-wide",children:"az"===r?"Rəsmi Akademik Karnet və Transkript":"Official Academic Record & Transcript"}),(0,s.jsx)("p",{className:"text-xs text-slate-400 mt-0.5",children:"az"===r?"Supabase bazasından toplanan real davamiyyət və tapşırıq nəticələri":"Verified attendance records and graded course assignments"})]}),(0,s.jsx)(o.E,{variant:"teal",children:c?.program||"Active Program"})]}),(0,s.jsxs)("div",{className:"grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6",children:[(0,s.jsxs)("div",{className:"p-4 rounded-2xl bg-[#070F1E] border border-slate-800",children:[(0,s.jsx)("span",{className:"text-xs text-slate-400",children:"az"===r?"\xdcmumi Davamiyyət Dəqiqliyi":"Attendance Accuracy"}),(0,s.jsxs)("h4",{className:"text-xl font-bold text-emerald-400 mt-1",children:[y,"% (",x," / ",m.length||1," dərslər)"]})]}),(0,s.jsxs)("div",{className:"p-4 rounded-2xl bg-[#070F1E] border border-slate-800",children:[(0,s.jsx)("span",{className:"text-xs text-slate-400",children:"az"===r?"Yoxlanmış Tapşırıqlar":"Evaluated Assignments"}),(0,s.jsxs)("h4",{className:"text-xl font-bold text-[#5ce1e6] mt-1",children:[g.filter(e=>"GRADED"===e.status).length," ədəd"]})]})]}),(0,s.jsx)("div",{className:"overflow-x-auto",children:(0,s.jsxs)("table",{className:"w-full text-left text-xs text-slate-300",children:[(0,s.jsx)("thead",{className:"bg-[#070F1E] text-slate-400 uppercase font-semibold text-[11px] border-b border-slate-800",children:(0,s.jsxs)("tr",{children:[(0,s.jsx)("th",{className:"py-3 px-4",children:"Tarix"}),(0,s.jsx)("th",{className:"py-3 px-4",children:"Fənn / Qrup"}),(0,s.jsx)("th",{className:"py-3 px-4",children:"Davamiyyət"}),(0,s.jsx)("th",{className:"py-3 px-4 text-center",children:"Status"})]})}),(0,s.jsx)("tbody",{className:"divide-y divide-slate-800/60 font-medium",children:m.map(e=>(0,s.jsxs)("tr",{className:"hover:bg-[#0D1E36]/40",children:[(0,s.jsx)("td",{className:"py-3.5 px-4 text-white font-mono",children:e.date}),(0,s.jsx)("td",{className:"py-3.5 px-4 font-bold text-white",children:e.groups?.name||"Class Session"}),(0,s.jsx)("td",{className:"py-3.5 px-4",children:(0,s.jsx)(o.E,{variant:"PRESENT"===e.status?"green":"rose",children:e.status})}),(0,s.jsx)("td",{className:"py-3.5 px-4 text-center",children:(0,s.jsx)("span",{className:"text-slate-400",children:"Time-Locked ✓"})})]},e.id))})]})})]})})})}r(4518)},8542:(e,t,r)=>{"use strict";r.d(t,{Z:()=>n});var s=r(5512);r(8009);var a=r(4195);let n=({children:e,className:t,hover:r=!1})=>(0,s.jsx)("div",{className:(0,a.cn)("bg-[#0D1E36] border border-slate-800/80 rounded-2xl p-5 shadow-xl",r&&"hover:border-[#4CA2B5]/40 transition-all duration-300 hover:shadow-2xl hover:shadow-[#4CA2B5]/5",t),children:e})},4518:(e,t,r)=>{"use strict";r.d(t,{W:()=>n});var s=r(5842);let a=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],n={async getLiveScheduleMatrix(e,t){try{let{data:r,error:n}=await s.N.from("group_schedules").select(`
          id,
          group_id,
          day_of_week,
          start_time,
        ...
        `).order("created_at",{ascending:!1});e&&(t=t.eq("student_id",e));let{data:r,error:a}=await t;if(a||!r)return[];return r}catch(e){return console.error("getExamResults error:",e),[]}}}},943:(e,t,r)=>{"use strict";r.r(t),r.d(t,{default:()=>s});let s=(0,r(6760).registerClientReference)(function(){throw Error("Attempted to call the default export of \"C:\\\\Users\\\\mexty\\\\OneDrive\\\\Desktop\\\\thrive-crm\\\\thrive-portal\\\\src\\\\app\\\\student\\\\academic\\\\page.tsx\" from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.")},"C:\\Users\\mexty\\OneDrive\\Desktop\\thrive-crm\\thrive-portal\\src\\app\\student\\academic\\page.tsx","default")}};var t=require("../../../webpack-runtime.js");t.C(e);var r=e=>t(t.s=e),s=t.X(0,[57,955,621,21,93],()=>r(1030));module.exports=s})();