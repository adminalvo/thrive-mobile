...
import { User, Mail, Phone, Globe, LogOut, Shield, ChevronRight } from 'lucide-react-native';
...
export const StudentProfileScreen: React.FC = () => {
  ...
  return (
    <View style={styles.container}>
      <HeaderBar title="Mənim Profilim" subtitle="Şəxsi Məlumatlar və Tənzimləmələr" />
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <ThriveCard style={styles.userCard}>
          ...
          <View style={{ marginTop: Spacing.sm }}>
            <ThriveBadge label="Tələbə Portalı" variant="primary" />
          </View>
        </ThriveCard>
