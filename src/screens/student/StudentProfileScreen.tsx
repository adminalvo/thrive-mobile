...
import { Mail, Phone, Globe, LogOut, ChevronRight } from 'lucide-react-native';
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <ThriveCard style={styles.userCard}>
          ...
          <View style={{ marginTop: Spacing.sm }}>
            <ThriveBadge label={`${t('common.student')} Portal`} variant="primary" />
          </View>
        </ThriveCard>
        ...
        <ThriveCard style={styles.infoCard}>
          <View style={styles.infoRow}>
            ...
            <View style={styles.infoTextCol}>
              <Text style={styles.infoLabel}>{t('common.student')} E-poçt</Text>
          ...
          <View style={styles.infoRow}>
            ...
            <View style={styles.infoTextCol}>
              <Text style={styles.infoLabel}>{t('common.student')} Telefon</Text>
