...
import { Calendar, CreditCard, Shield, CheckCircle } from 'lucide-react-native';
  ...
  return (
    <View style={styles.container}>
      <HeaderBar
        ...
        subtitle={activeChild ? `${activeChild.fullName} • ${t('parent.paymentsSubtitle')}` : t('parent.paymentsSubtitle')}
      />
      ...
      >
        {loading ? (
          ...
          <>
            ...
            <Text style={styles.sectionTitle}>{t('parent.financeAndTuition')}</Text>
            <ThriveCard style={styles.infoCard}>
              <View style={styles.securityRow}>
                <CheckCircle size={20} color={Colors.success} />
                <View style={{ flex: 1 }}>
                  <Text style={styles.infoTitle}>{t('payments.officialReportTitle')}</Text>
